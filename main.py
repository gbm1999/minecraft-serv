...
os.system('nohup java -XX:+UnlockExperimentalVMOptions -XX:+UseCGroupMemoryLimitForHeap -XX:+UseG1GC -verbose:gc -Xmx300m -Djline.terminal=jline.UnsupportedTerminal -Xms300m -jar server.jar > nohup.out &')
